...
return null;
  ...
  <TabsList className="bg-gradient-to-l  from-emerald-600/30 via-purple-700/50 to-emerald-900/60 opacity-80 flex flex-col md:flex-row rounded-none items-center justify-center w-auto h-auto ">
    <TabsTrigger className="hover:bg-purple-400/40 hover:text-emerald-200 text-emerald-400 z-10 data-[state=active]:text-emerald-300 data-[state=active]:bg-purple-600/70" value="subcategory1">Subcategory1</TabsTrigger>
    <TabsTrigger className="hover:bg-purple-400/40 hover:text-emerald-200 text-emerald-400 z-10 data-[state=active]:text-emerald-300 data-[state=active]:bg-purple-600/70"value="subcategory2">Subcategory2</TabsTrigger>
    <TabsTrigger className="hover:bg-purple-400/40 hover:text-emerald-200 text-emerald-400 z-10 data-[state=active]:text-emerald-300 data-[state=active]:bg-purple-600/70"value="subcategory3">Subcategory3</TabsTrigger>
  </TabsList>
