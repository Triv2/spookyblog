...
const ArticleCard = ({
  ...
  return (
    ...
    <Card className="bg-slate-900 w-full h-full cursor-none">
      ...
      <div className="md:w-[65%] text-purple-100/80 text-ellipsis line-clamp-5 overflow-hidden "> 
      ...
      <CardFooter className="flex justify-between items-center gap-2">
        <Button className="z-10 hover:scale-105 bg-gradient-to-br text-emerald-400 from-purple-600/40 to-emerald-900/60" variant="purple" asChild>
